            ...
            {openSetting ? (
                ...
                <SafeAreaView className="flex-1 bg-[#B87C4C] h-full">
                    <View>
                        ...
                        <View>
                            <Text className="text-2xl font-bold text-white my-2 pl-5">
                                My Routine
                            </Text>
                        ...
                        <View className="py-2">
                            <View className="flex-row justify-between w-full pr-5">
                                <Text className="text-2xl font-bold text-white pl-5">
                                    AM Routine
                                </Text>
