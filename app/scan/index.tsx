                ...
                <SafeAreaView className="bg-[#F7F4EA] w-full justify-center flex-1 relative">
                    ...
                    <View className="bg-[#F7F4EA] w-full justify-center px-5 flex-1 relative">
                        ...
                        <TouchableOpacity
                            ...
                            className="absolute bg-[#F7F4EA] rounded-full p-2 self-center top-8 border-2 border-[#B87C4C]"
                        >
            ...
            {selectedOption === "scan" && !capturedPhoto && !settingOpen && (
                <>
                    <TouchableOpacity
                        ...
                        className="absolute z-[0] self-center bottom-44 bg-[#B87C4C] rounded-full p-4 border-4 border-[#F7F4EA]"
                    >
                        ...
                        <View className="bg-[#F7F4EA] rounded-full px-4 py-2">
                            <View className="flex flex-row items-center justify-center gap-2">
                                <Scan
                                    ...
                                    color="#B87C4C"
                                />
                                <Text className="font-bold text-2xl m-0 text-[#B87C4C]">
                                    Scan
                                </Text>
                            </View>
                        </View>
